           ...
           <div class="row">              
	         <div class="mb-3">
	          ...
	          <div class="mb-3">
	            ...
	            <a class="nav-link" href="${pageContext.request.contextPath}/member/changepass.do"><input type="button" value="비밀번호 변경"></a>
	          ...
	          <!--           <div class="mb-3">
	           ...
	           <div class="mb-3">
	              ...
	              pattern="[가-힣]{2,7}" value="${membersDTO.memberName}" >
	              <div class="invalid-feedback">
